...
workflow AQUASCOPE {
    ...
    MINIMAP2_ALIGN_SHORT (
        ch_trimmed_reads_short, ch_genome, true, false, false 
    )
    ...
    MINIMAP2_ALIGN_LONG (
        ch_trimmed_reads_long, ch_genome, true, false, false 
    )
    ...
    ONT_TRIMMING(
        ch_long_align_bam, params.save_cliprejects, params.save_clipstats
    )
